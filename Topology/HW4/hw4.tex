...
Let $\mathbb{R}$ be a topological space with the standard topology. Let the two sets be the open interval $(0,1)$ and $(1,2)$ then we have $(0,1)^\prime=[0,1]$ as for any $x\in (0,1)$ any neighborhood $O$ of $x$ we have a basis $(a,b)$ where $a,b\in \mathbb{R}$ with $x\in (a,b)\subset U \subset (0,1)$ and as $(a,b)\cap (0,1)=(a,b)$ then we have $x$ is a limit point. Now to show that $0\in (0,1)^\prime$ we have for any neighborhood $O$ of $0$ that 

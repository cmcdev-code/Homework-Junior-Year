...
Then we have the the six subdivisions $t_0=0,t_1=\pi/4,t_2=3\pi/4,t_3=5\pi/4,t_4=7\pi/4,t_5=2\pi$. With the angle function just being the angle of the point in polar coordinates.
}

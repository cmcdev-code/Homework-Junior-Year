...
I will be using the four sectors $$U_0=\{(x,y): 0 < \text{angle in polar }(x,y)<\pi \}$$ $$U_1=\{(x,y): \pi/2< \text{angle in polar}(x,y)<3\pi/2\}$$  
$$
U_2=\{(x,y): \pi < \text{angle in polar}(x,y)<2\pi\}
$$
$$
U_3=\{(x,y): 3\pi/2 < \text{angle in polar}(x,y)< 5\pi/2\}
$$
...
Then 
\[
    W(f,(0,0))=\frac{1}{2\pi}\big(\theta_0((1,0)) \big)
\]

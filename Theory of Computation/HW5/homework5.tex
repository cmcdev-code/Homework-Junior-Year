...
\begin{figure}[tp]
\begin{center}
\input hw5_1_e-NFA.pdf_t
\end{center}
\caption{The labeled directed graph
or state diagram representation of $\emptystring$-NFA $N_2$ for Problem 2.}
\label{figure:e-NFA_Problem2}
\end{figure}
